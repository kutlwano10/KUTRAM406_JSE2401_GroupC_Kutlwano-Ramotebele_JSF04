...
<template>
  ...
  <div v-else-if="store.singleProduct" class="mt-6 sm:mt-8 lg:flex lg:items-start  lg:max-w-6xl xl:max-w-7xl ">
      ...
      <div class="mx-auto  w-[90%] space-y-2 ">
        ...
        <h1 class="text-2xl md:text-4xl lg:text-4xl font-bold">{{store.singleProduct.title}}</h1>
